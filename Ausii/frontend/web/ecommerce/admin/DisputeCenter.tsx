    ...
    <div className="p-8 bg-[#fdfdfd] text-[#1a1a1a] min-h-screen font-['Inter']">
      <div className="max-w-7xl mx-auto">
        <header className="flex justify-between items-center mb-12 border-b border-gray-100 pb-8">
          <div>
            <h1 className="text-5xl font-black tracking-tighter text-[#111] uppercase">Dispute Center</h1>
            <p className="text-gray-400 mt-2 font-medium tracking-widest text-xs uppercase">E-Commerce Module | Ref: #159</p>
          </div>
        ...
        <main className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <aside className="lg:col-span-4 space-y-8">
             <div className="bg-[#111] p-10 rounded-[40px] text-white shadow-2xl shadow-indigo-500/20 relative overflow-hidden group">
                ...
                <p className="text-gray-400 text-sm leading-relaxed font-medium mb-10 italic">"Dispute Center is optimized for bulk operations and comparison-heavy discovery."</p>
